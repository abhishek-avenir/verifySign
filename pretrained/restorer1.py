...
anchor_image = "Test/original/original2.jpeg"
input_image = "Test/original/original 3.jpeg"

           
sig1_img = cv2.imread(anchor_image, 0)
cv2.imshow("Image", sig1_img)
cv2.waitKey(0)
...
sig2_img = cv2.imread(input_image, 0)
...
if out==1:
    ...
    label=True
if label==True:
    print("Result","The signatures match!")
else:
    print("Result","The two signatures do not match!")
